import requests # library for webservices
import json
import pandas as pd
# answer saved in a variable

response = requests.get(url='http://api.open-notify.org/astros.json') # how to send the request

print(response.status_code) # Is the request seccessful or not ?
